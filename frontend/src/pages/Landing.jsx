...
const Landing = () => {
  ...
  const dashboardPath = role === "admin" ? "/admin" : role === "auditor" ? "/admin/audit" : "/electeur";
  const electionsPath = role === "admin" ? "/admin/elections" : role === "auditor" ? "/admin/audit" : "/electeur/vote";
  const resultsPath = role === "admin" ? "/admin/resultats" : role === "auditor" ? "/admin/audit" : "/electeur/resultats";

  const handleProtectedNavigation = (e, targetPath, section) => {
    e.preventDefault();
        ...
        <div className="flex justify-between items-center px-4 md:px-16 py-4 max-w-7xl mx-auto">
          ...
          <nav className="hidden md:flex gap-2">
            <button
              ...
              onClick={(e) => handleProtectedNavigation(e, dashboardPath, "top")}
            >
              Accueil
            </button>
            <button
              ...
              onClick={(e) => handleProtectedNavigation(e, electionsPath, "elections")}
            >
              Scrutins
            </button>
            <button
              ...
              onClick={(e) => handleProtectedNavigation(e, resultsPath, "results")}
            >
              Résultats
            </button>
          </nav>
      ...
      <footer className="bg-gradient-to-br from-[#1e3a5f] to-[#16304d] text-gray-300 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            ...
            <p>Projet tutoré - Système de vote électronique sécurisé</p>
          </div>
        </div>
      </footer>
    </div>
