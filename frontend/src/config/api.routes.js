...
const API_ROUTES = {
  ...
  ELECTIONS: {
     ...
     * Headers: Authorization: Bearer {token} (Admin)
     * Body: { titre: string, description: string, date_debut: DateTime, date_fin: DateTime }
     ...
     * Response: { success: boolean, election: Object }
     */
    PUBLISH: (id) => `/elections/${id}/publier`,

    /**
     * POST /api/elections/{id}/cloturer
     * Clôturer une élection manuellement
     * Headers: Authorization: Bearer {token} (Admin)
     * Response: { success: boolean, election: Object }
     */
    CLOSE: (id) => `/elections/${id}/cloturer`,
     ...
     */
    CANDIDATES: (id) => `/elections/${id}/candidats`,
  ...
  CANDIDATES: {
     ...
     */
    CREATE: (electionId) => `/elections/${electionId}/candidats`,
